...
const ServiceDay1WorkSchema = Type.String({ format: 'iso-time' })
const ServiceDay2WorkSchema = Type.String({ format: 'iso-time' })
const ServiceDay3WorkSchema = Type.String({ format: 'iso-time' })
const ServiceDay4WorkSchema = Type.String({ format: 'iso-time' })
const ServiceDay5WorkSchema = Type.String({ format: 'iso-time' })

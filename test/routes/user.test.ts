...
describe('POST /users/login HTTP', async () => {
  ...
  it('Get /users/:id returns user', async () => {
    ...
    assert.deepStrictEqual(parsedResponse.userFirstName, 'SuperAdmin')
    assert.deepStrictEqual(parsedResponse.userLastName, 'SuperAdmin')
    assert.deepStrictEqual(parsedResponse.userEmail, 'superadmin@test.com')
    ...
    await fc.assert(
      fc.asyncProperty(
        ...
        async (firstName, lastName, email) => {
          ...
          assert.deepStrictEqual(parsedGetResponse.userFirstName, firstName)
          assert.deepStrictEqual(parsedGetResponse.userLastName, lastName)
          assert.deepStrictEqual(parsedGetResponse.userEmail, email)
